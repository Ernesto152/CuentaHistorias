                    ...
                    <div id="tu">
                        <h4>
                            ...
                            <c:forEach var="word"  items="${service.randomWords}" varStatus="record">
                                <input id="nombre" name="nombre" cssClass="btn btn-primary" class="btn btn-primary" value="${word.name}">
                            </c:forEach>
                            ...
                            <c:forEach var="word"  items="${service2.randomWords}" varStatus="record">
                               <input id="nombre2" name="nombre2" cssClass="btn btn-primary" class="btn btn-primary" value="${word.name}">
                            </c:forEach>
                            ...
                            <c:forEach var="word"  items="${service3.randomWords}" varStatus="record">
                                <input id="nombre3" name="nombre3" cssClass="btn btn-primary" class="btn btn-primary" value="${word.name}">
                            </c:forEach>
                            ...
                            <c:forEach var="word"  items="${service4.randomWords}" varStatus="record">
                                <input id="nombre4" name="nombre4" cssClass="btn btn-primary" class="btn btn-primary" value="${word.name}">
                            </c:forEach>
                            ...
                            <c:forEach var="word"  items="${service5.randomWords}" varStatus="record">
                                <input id="nombre5" name="nombre5" cssClass="btn btn-primary" class="btn btn-primary" value="${word.name}">
                            </c:forEach>
